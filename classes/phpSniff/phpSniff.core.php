...
class phpSniff_core {   // initialize some vars
    ...
    function _get_os_info() {   // regexes to use
        ...
        if (preg_match_all($regex_windows, $this->_browser_info['ua'], $match)) { /** Windows has some of the most ridiculous HTTP_USER_AGENT strings */
