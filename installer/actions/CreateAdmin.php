...
class CreateAdmin extends SQLAction {
    ...
    function perform() {
        ...
        $sql = "INSERT INTO care_users (name, login_id, password, role_id, exc, modify_id, create_id) "
                . " VALUES ('admin', '" . $this->admin_user . "', '" . md5($this->admin_pass) . "', 1, 1, 'auto-installer', 'auto-installer')";

        $sql1 = "INSERT INTO care_user_roles (description, permission, modify_id, create_id"
                . " VALUES ('System Admin', 'System_Admin', 1, 'auto-installer', 'auto-installer')";
