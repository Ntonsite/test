...
// end of constructor
	...
	function InitializeGUI() {
		...
		# Set colors
		$this->cfg['top_txtcolor']=isset($this->cfg['top_txtcolor'])? $this->cfg['top_txtcolor'] : "";
		$this->cfg['body_txtcolor']=isset($this->cfg['body_txtcolor'])? $this->cfg['body_txtcolor'] : "";
		$this->cfg['top_bgcolor']=isset($this->cfg['top_bgcolor']) ? $this->cfg['top_bgcolor'] : "";
		$this->cfg['body_bgcolor']=isset($this->cfg['body_bgcolor']) ? $this->cfg['body_bgcolor'] : "";
		$this->cfg['bot_bgcolor']=isset($this->cfg['bot_bgcolor']) ? $this->cfg['bot_bgcolor'] : "";
		...
		$this->cfg['dhtml']=isset($this->cfg['dhtml']) ? $this->cfg['dhtml'] : "";
	...
	function Copyright() {
		...
		if (file_exists($sTempFile)) {
			...
			include $this->root_path . 'language/en/en_copyrite.php';
		}
