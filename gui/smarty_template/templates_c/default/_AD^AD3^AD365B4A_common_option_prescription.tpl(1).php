<?php /* Smarty version 2.6.22, created on 2019-12-07 13:27:45
        ...
        <tr>
            <td>
                <table cellspacing="0" cellpadding="0" width="100%" border="1" class="table table-bordered table-condensed">
                    <tr valign="top">
                        <td>
                            <?php if ($this->_tpl_vars['notDiagnosed']): ?>
                                <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "registration_admission/common_notdiagnonized.tpl", 'smarty_include_vars' => array()));
