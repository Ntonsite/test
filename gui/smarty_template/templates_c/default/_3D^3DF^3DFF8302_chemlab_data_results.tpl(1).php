<?php /* Smarty version 2.6.22, created on 2020-10-30 20:20:12
...
:</td>
 ...
 <?php echo $this->_tpl_vars['sMiniCalendar']; ?>
                    ...
                    <table width="100%"  bgcolor=#ffdddd  class="table table-condensed" style="position: relative;">
                        <tbody>                            
                            ...
                            <?php else: ?>
                                ...
                                <?php if ($this->_tpl_vars['uploadedFile']): ?>
                                <tr>
                                    <td colspan="2">
                                        ...
                                        <div class="alert alert-success">
                                            ...
                                            <span>
                                              <b> Uploaded - </b> Patient file was successfully uploaded</span>
                                        </div>
                                    </td>
                                </tr>
                                <?php else: ?>
                            ...
                            <tr>
                             ...
                             <tr>
                                ...
                                <td align="right"><?php echo $this->_tpl_vars['comment']; ?>
</td>
                            </tr>
                            <tr>
                                <td><?php echo $this->_tpl_vars['pbSave']; ?>
 &nbsp;  &nbsp;   &nbsp;   <?php echo $this->_tpl_vars['pbSaveDone']; ?>
 ...
 <?php echo $this->_tpl_vars['pbCancel']; ?>
                ...
                <div style="position: absolute; top:210px; right: 10%; ">
