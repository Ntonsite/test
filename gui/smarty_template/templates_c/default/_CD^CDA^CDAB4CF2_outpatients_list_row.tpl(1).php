<?php /* Smarty version 2.6.22, created on 2019-11-19 10:22:47
         compiled from ambulatory/outpatients_list_row.tpl */ ?>

<?php if ($this->_tpl_vars['bToggleRowClass']): ?>
<tr class="wardlistrow1 hoverTable" <?php echo $this->_tpl_vars['sFlagDiag']; ?>
>
    <?php else: ?>
<tr class="wardlistrow2 hoverTable" <?php echo $this->_tpl_vars['sFlagDiag2']; ?>
 >
    <?php endif; ?>
...
<?php echo $this->_tpl_vars['cComma']; ?>
 <?php echo $this->_tpl_vars['sName']; ?>
    ...
    <td>&nbsp; <?php echo $this->_tpl_vars['sOPRoom']; ?>
