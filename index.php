...
# the session time out start time
...
$GLOBALCONFIG['language_single']=$GLOBALCONFIG['language_single'] ?? "";
...
if ($mask == 2) {
	...
	#
	//echo $GLOBALCONFIG['gui_frame_left_nav_width'].'<br>';
	//echo $GLOBALCONFIG['gui_frame_left_nav_border'];
	$GLOBALCONFIG['gui_frame_left_nav_width']=isset($GLOBALCONFIG['gui_frame_left_nav_width'])? $GLOBALCONFIG['gui_frame_left_nav_width'] : "";
	$GLOBALCONFIG['gui_frame_left_nav_border']=isset($GLOBALCONFIG['gui_frame_left_nav_border']) ? $GLOBALCONFIG['gui_frame_left_nav_border'] : "";
