...
<table border=0 cellspacing=5 cellpadding=5>
    <tr bgcolor="<?php
    if ($searchmask_bgcolor)
        echo $searchmask_bgcolor;
    else
        echo "#ffffff";
    ?>">
        <td>
            ...
            <?php
            $searchform_count=$searchform_count ?? "";
            ?>
            ...
            <?php if (isset($search_script) && $search_script != '') echo 'action="' . $search_script . '"'; ?>
                ...
                <input type="text" name="searchkey" size=40 maxlength=80><p>
                    ...
                    if (defined('SHOW_CTC_NO_CONTROLLER') && SHOW_CTC_NO_CONTROLLER) {
                        ?>
                    <input type="checkbox" name="ctc_no_too" <?php if (isset($ctc_no_too) && $ctc_no_too) echo 'checked'; ?>> <?php echo $LDIncludeCTCNo; ?><p>
                        <?php
                    }

                        $noresize=isset($noresize) ? : null;
                        $aux1=isset($aux1) ? : null;
                        $ipath=isset($ipath) ? : null;
                        $lang=isset($lang) ? : null;
                        $sid=isset($sid) ? : null;
                        $retpath=isset($retpath) ? : null;
                    ?>
                    ...
                    <input type="hidden" name="aux1" value="<?php echo $aux1=$aux1 ?? ""; ?>">
