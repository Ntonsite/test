 ...
 * Class edited and customized by Patrick Mark
 *
...
//------------------------------------------------------------------------------------------------------------------------------------------------
    function setARVdata($values) {
        $this->arv_patient_data = $values;
    }

//------------------------------------------------------------------------------------------------------------------------------------------------
    function getARVcaseID() {
        return $this->arv_patient_data['care_tz_arv_case_id'];
    }
