 ...
 */
			...
			if (empty($GLOBAL_CONFIG['person_title_hide'])) {
			...
			if (empty($GLOBAL_CONFIG['person_bloodgroup_hide']) && trim($blood_group)) {
			...
			if (empty($GLOBAL_CONFIG['person_civilstatus_hide']) && trim($civil_status)) {
			...
			if (empty($GLOBAL_CONFIG['person_insurance_hide'])) {
			...
			if (empty($GLOBAL_CONFIG['person_citizenship_hide']) && $citizenship) {
			...
			if (empty($GLOBAL_CONFIG['person_other_his_nr_hide'])) {
				$other_hosp_list = $this->person_obj->OtherHospNrList();
				$other_hosp_list = $other_hosp_list ?? [];

				if (is_array($other_hosp_list) || is_object($other_hosp_list)) {
