 ...
 * @author
 * @version beta 3.5
 * @copyright 2002,2003,2004,2005,2005 Elpidio Latorilla 2011-2017 LUICo
 * @package care_api
 *
...
//        echo $token;
		...
		if ($status['http_code'] === 200) {
			...
			return $decoded;
		} else if ($status['http_code'] === 401) {
			//Access denied, may be invalid token
...
//        echo $token.' -------Tokennnn';
		//Initialize curl
		$curl = curl_init("https://verification.nhif.or.tz/apiserver/api/v1/verification/GetVerificationDetails?CardNo=$card_no");
