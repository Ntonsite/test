...
if (isset($_GET['bill_number'])) {
    $sql = 'SELECT encounter_nr,b.is_printed,description,price,amount,is_paid, ID'
            . ' FROM care_tz_billing_archive b INNER JOIN care_tz_billing_archive_elem be '
            . ' ON b.nr=be.nr where b.is_printed=0 AND b.nr=' . $_GET['bill_number'];
