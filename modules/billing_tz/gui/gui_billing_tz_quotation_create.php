...
<BODY bgcolor="#ffffff" link="#000066" alink="#cc0000" vlink="#000066" onLoad="setBallon('BallonTip', '', '')" >
    ...
    <script language="javascript">
        ...
        function chkform(form) {
            ...
            var healthFund = $("#insurance").val();
            var insrID = "<?php echo $ins_id; ?>";
            var totalAdv = "<?php echo $bill_obj->GetAdvanceTotalAmountQuotation($_REQUEST['encounter_nr']); ?>";
            var clearcheck = document.getElementById('clear_bill');
            var bankEnabled = "<?php echo $bank_enabled;?>";
            var bankref = $("#bankid").val();

            var healthFund = parseInt(healthFund, 10);
            var insrID = parseInt(insrID, 10);
            ...
            if (totalAdv>0 && clearcheck.checked==false) {
	...
	?>
                                        <tr>
                                            <td bgcolor="#ffffdd" width="80" colspan="4">
                                                ...
                                                <input type="hidden" value="<?php echo $_GET['insrname']; ?>" name="insrname">
...
?>
                                    ...
                                    function TriggerAllItems(trigger)
                                    {
                                        ...
                                        if (trigger == 0)
                                            ...
                                            showtr = false; // end of if(trigger==0)
<?php
$this_arraycount = 0;
                                ...
                                <table width="600" border="0" align="center">
                                    ...
                                    <tr>
                                        <td colspan="2">
                                            ...
                                            <input type="button" value ="<?php print $LDProcessAdvance;?>" onclick="window.location.href = '<?php print $root_path . 'modules/billing_tz/billing_tz_advance.php' . URL_APPEND . '&batch_nr=' . $pid . '&encounter_nr=' . $_REQUEST['encounter_nr'] . '&insrname=' . $_REQUEST['insrname'] . '&bank_enabled=' . $bank_enabled . '&patient=' . $patient;?>';">
                    ...
                    <table width="600" border="0" align="center">
                        ...
                        <tr align="left">
                            ...
                            <td colspan="4">
                                ...
                                <b><?php echo $bill_obj->GetAdvanceTotalAmountQuotation($_REQUEST['encounter_nr']); ?></b>
                            </td>
                        </tr>
...
if ($bank_enabled == '1' && $_REQUEST['insrname'] == 'Cash-Patient') {
	?>
                                            <tr>
                                        <td align="right" bgcolor="#BED0BB" class="style3">Bank Ref:</td>
                                        <td bgcolor="#E2EAE1">
                                            <input type="text" name="bankid"  id="bankid" placeholder="Enter Bank Ref Here">
                                        </td>
                                    </tr>
...
?>
                                    ...
                                    <tr>
                                        <td align="right" bgcolor="#BED0BB" class="style3">REFUND/TOPUP</td>
                                        <td bgcolor="#E2EAE1">
                                    ...
                                    <tr>
                                        <td colspan=2 align="right" bgcolor="#FFFFCC" class="style3">TICK HERE IF THIS IS FINAL BILL
                        ...
                        <tr>
                            ...
                            <td align="right">
                                <input type="submit" id="finish" name="finish" value="<?php echo $LDFinished; ?>">
                            </td>
                        </tr>
                    </table>
                </td>
