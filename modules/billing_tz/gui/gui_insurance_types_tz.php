	...
	<tr>
		<td height=75>
			...
			<table border="2" cellpadding="2" cellspacing="0" width="550" align="center">
				<tr bgcolor=ffffaa>
					<td><?php $insurance_tz->ShowRedIfError('' . $LDCompanyName . '', @$error['name'] ? $error['name'] : "");?></td>
...
<!--				<tr bgcolor=ffffee>
				...
				<tr bgcolor=ffffee>
					<td><?php $insurance_tz->ShowRedIfError('' . $LDContractPerson . '', @$error['contact'] ? $error['contact'] : "");?></td>
			...
			<table border=0 align="center">
				<tr>
					<td><input type="checkbox" name="invoice_flag" value="" <?php if (@$this_insurance['invoice_flag']) {
	echo 'checked';
}
?>><?php echo $LDPaybyInvoice; ?> </td>
					<td><input type="checkbox" name="credit_preselection_flag" value="" <?php if (@$this_insurance['credit_preselection_flag']) {
	echo 'checked';
}
