...
<table>
	<tr>
		<?php $updated = $updated ?? "";?>
		<?php $error = $error ?? "";?>
		<?php $hide_company_flag = @$this_insurance['hide_company_flag'] ? $this_insurance['hide_company_flag'] : 0;?>
		<?php $error_hide_company_flag = @$error['hide_company_flag'] ? $error['hide_company_flag'] : "";?>
	...
	<tr>
		<td><?php $insurance_tz->ShowRedIfError('' . $LDHideCompany . '', $error_hide_company_flag);?>:
		<input type="checkbox" name="hide_company_flag" value="<?php if ($hide_company_flag) {
	echo 'checked';
}
?>"><?php echo $LDYes; ?> </td>
	</tr>
...
<!--				<tr bgcolor=ffffee>
				...
				<tr bgcolor=ffffaa>
					<?php $error_hide_prepaid_amount = @$error['hide_prepaid_amount'] ? $error['hide_prepaid_amount'] : "";?>
					<td><?php $insurance_tz->ShowRedIfError('' . $LDPrepaid_Amount . '', $error_hide_prepaid_amount);?>:</td>
					<td><input type="text" name="prepaid_amount" size=25 value="<?php echo $this_insurance['prepaid_amount']; ?>">&nbsp; <?php echo $LDTSH; ?></td>
				</tr>
			</table>
			<table border=0 align="center">
				<tr>
					<td><input type="checkbox" name="invoice_flag"  <?php if ($this_insurance['invoice_flag']) {
	echo 'checked';
}
...
?>><?php echo $LDMemberContractExpiry; ?> </td>
					<td><input type="checkbox" name="credit_preselection_flag"  <?php if ($this_insurance['credit_preselection_flag']) {
	echo 'checked';
}
