...
<BODY bgcolor="#ffffff" link="#000066" alink="#cc0000" vlink="#000066" onLoad="setBallon('BallonTip', '', '')" >
    ...
    <script language="javascript">
        ...
        function chkform(form) {
            ...
            final_bill = document.getElementById('final_bill');
            ...
            if (isNaN(advance.value) || advance.value < 0) {
                alert("Wrong Value!Enter advance amount(numbers only) and amount greater than zero!");
                advance.focus();
                return false;
            }
            else 
            if (bankEnabled==1&&bankid.value=="") {
    ...
    //echo 'bankid='.$bankid.'<br>'.'ins_id= '.$ins_id;
                        ...
                        <tr>
                            <td>
                                ...
                                <table>
                                    ...
                                    <tr>
                                        <td bgcolor="#ffffdd" width="80" colspan="4">
                                           ...
                                           <!-- <input type="hidden" value="<?php  //echo $bill_obj->CheckFinalBill($encounter_nr);   ?>" name="final_bill" id="final_bill">-->
                                ...
                                <table width="600" border="0" align="center">
                                    ...
                                    if($_REQUEST['bank_enabled']==1 && $_REQUEST['insrname']=='Cash-Patient' ){
                                        ?>
                                        <tr>
                                        <td align="right">
                                            Bank Ref:
                                        ...
                                        <td align="left">
                                            <input type="text" name="bankid" id="bankid" placeholder="Enter Bank Ref Here" size=15>
                                        </td>
                                    ...
                                    <tr>
                                        <td colspan=2 align="right">
                                            <input type="submit" name="finish" id="finish" value="<?php echo $LDFinished; ?>">
                                        </td>
                                    </tr>
                                </table>
                            </td>
                        ...
                        <tr> 
                            <td>
                                ...
                                <table width="600" align="center">
                                    ...
                                    <td ' . $BGCOLOR . ' class="td_content"><div align="centre">' . $adv_row['notes'] . '</div></td>
