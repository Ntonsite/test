...
?>
                        ...
                        <p>
                        <input type="checkbox" name="visit" value="1" <?php if (($edit_form || $read_form) && $stored_request['visit']) {
	echo "checked";
}
?>> <?php echo $LDVisitRequested ?><p>
                        <input type="checkbox" name="order_patient" value="1" <?php if (($edit_form || $read_form) && $stored_request['order_patient']) {
	echo "checked";
}
?>> <?php echo $LDPatCanBeOrdered ?><p>
                            <?php
...
?>
            ...
            <tr bgcolor="<?php echo $bgc1 ?>">
                <td colspan=2><div class=fva2_ml10><?php echo $LDDiagnosesInquiries ?><br>
                        <textarea name="diagnosis_quiry" cols=80 rows=10 wrap="physical"><?php if ($edit_form || $read_form) {
	echo stripslashes($stored_request['diagnosis_quiry']);
}
?></textarea>
                </td>
            </tr>
