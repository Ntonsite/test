                                                ...
                                                <tr>
                                                    <td>
                                                        <table border=0 bgcolor="<?php echo $bgc1 ?>" cellpadding=4 width=100%>
                                                            ...
                                                            <tr class=fva0_ml10>
                                                                <td colspan=3><?php echo $LDDateProtNumber ?><br><input type="text" name="date_protoc_nr" size=45 maxlength=45 value="<?php if ($edit_form || $read_form) {
                                                    ...
                                                    <td>
                                                        <table border=0 cellpadding=1 cellspacing=1 width=100% height=100%>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="pure_blood" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="red_blood" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="leukoless_blood" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="washed_blood" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
	echo $stored_request['washed_blood'];
}
?>"></td>
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                <td>&nbsp;<?php echo $LDPRP ?></td>
                                                                <td align="center"><input type="text" name="prp_blood" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="thrombo_con" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="ffp_plasma" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>"></td>
                                                            ...
                                                            <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                ...
                                                                <td align="center"><input type="text" name="transfusion_dev" size=6 maxlength=6 value="<?php if ($edit_form || $read_form) {
...
?>
                                                ...
                                                <tr>
                                                    <td colspan=2><div class=fva2b_ml10><b><?php echo $LDDiagnosis ?></b><br>
                                                            <textarea name="diagnosis" cols=35 rows=2 wrap="physical"><?php if ($edit_form || $read_form) {
...
?></textarea></div></td>
                                                ...
                                                <tr>
                                                    <td colspan=2> <div class=fva2b_ml10><font size=1><?php echo $LDNotesRequests ?></font><br>
                                                            <textarea name="notes" cols=35 rows=2 wrap="physical"><?php if ($edit_form || $read_form) {
...
?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" name="phone_nr" size=20 maxlength=20 value="<?php if ($edit_form || $read_form) {
