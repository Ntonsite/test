...
?>
            ...
            <tr bgcolor="<?php echo $bgc1 ?>">
                ...
                <td colspan=3><font size=3 color="#cc0000" face="verdana,arial">
                    <input type="text" name="material_note" size=40 maxlength=40 value="<?php if ($edit_form || $read_form) {
	echo stripslashes($stored_request['material_note']);
}
?>">
                    <br>
                    <input type="text" name="diagnosis_note" size=40 maxlength=40 value="<?php if ($edit_form || $read_form) {
	echo stripslashes($stored_request['diagnosis_note']);
}
?>"><br>
                    </font>
                    <font size=1 color="#990000" face="verdana,arial">
                    <input type="radio" name="immune_supp" value=1 <?php if (($edit_form || $read_form) && $stored_request['immune_supp']) {
	echo "checked";
}
?>> <?php echo $LDYes ?>	<input type="radio" name="immune_supp" value=0  <?php if (!$mode || !$stored_request['immune_supp']) {
	echo "checked";
}
?>> <?php echo $LDNo ?><br>
                </td>
