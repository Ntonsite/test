...
if ($mode == 'match' || $mode == 'search' || $mode == 'paginate') {
    ...
    $select_sql = "SELECT o.*, e.encounter_class_nr, UPPER(p.name_last) as name_last, CONCAT(p.name_first,' ', p.name_2) AS name_first, p.date_birth,p.sex,d.name_formal,d.LD_var AS \"LD_var\"";
    ...
    if (!isset($all_depts) || $all_depts == 'false')
...
if ($rows && !$patientselected) {
  ...
  <td colspan=8 height=1><img src="' . $root_path . 'gui/img/common/default/pixel.gif" border=0 width=1 height=1 align="absmiddle"></td>
    ...
    ?>
                              ...
                              <tr bgcolor="#ffffff">
                                <td><?php echo $LDPostOrders ?>:
                                </td>
                                <td>
    <?php echo '<font color="#800000">' . $row['postorder'];
    ?>
                                </td>
                            </tr>

                             <tr bgcolor="#ffffff">
                                <td><?php echo $LDTypesAnaesthesia ?>:
                                </td>
                                <td>
    <?php echo '<font color="#800000">' . $row['anaesthesia_type'];
    ?>
                                </td>
                            </tr>
                            <tr bgcolor="#ffffff">
                                ...
                                <td>
                                    ...
                                    <?php
                                    if ($row['class_s'])
                                        echo $row['class_s'] . " $LDMinor  &nbsp; ";
                                    if ($row['class_m'])
                                        echo $row['class_m'] . " $LDMiddle &nbsp; ";
                                    if ($row['class_l'])
                                        echo $row['class_l'] . " $LDMajor";
                                    echo " $LDOperation";
                                    ?>
                                </td>
                            </tr>
                    ...
                    <p>
                        ...
                        ?>
                        <font color="#0"><?php echo $LDAnasthetist ?>: 
    <?php echo '<font color="#800000">' . $row['anasthetist'] . ' &nbsp;';
    ?>
                        <font color="#0"><?php echo $LDScrubNurse ?>: 
    <?php echo '<font color="#800000">' . $row['scrub_nurse'] . ' &nbsp;';
    ?>
                        <font color="#0"><?php echo $LDAssitant ?>: 
                        <?php echo '<font color="#800000">' . $row['assistant'] . ' &nbsp;'; ?> 
