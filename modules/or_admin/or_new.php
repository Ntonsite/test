...
if ($mode == 'select' || $mode == 'update') {
	echo '<input type="hidden" name="room_nr"  value="' . $room_nr . '">' . $room_nr;
} else {
	?>
...
?>
            ...
            <tr>
                ...
                <td bgColor="#f9f9f9"><input type="radio" name="is_temp_closed" value="0" <?php if (!$is_temp_closed) {
	echo 'checked';
}
?>> <?php echo $LDNo ?> <input type="radio" name="is_temp_closed" value="1" <?php if ($is_temp_closed) {
	echo 'checked';
}
?>> <?php echo $LDYes ?>
                </td>
