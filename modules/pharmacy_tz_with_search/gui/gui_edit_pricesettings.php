...
<tbody class="main">
 ...
 <form ENCTYPE="multipart/form-data" action="edit_pricesettings.php" method="POST" name="inputform">
  <table border="1" cellspacing="0" colspacing="0" class="table_content">
    ...
    <tr>
      <td class="td_content">8</td>
      <td class="td_content">
      <input type="text" name="short_8" value="<?php echo $short_8;?>" size="20"/>      </td>
      <td class="td_content"><input type="text" name="long_8" value="<?php echo $long_8;?>" size="40"/></td>
      <td class="td_content"><div align="center">
        <input type="checkbox" name="is_insurance" value="8" <?php if ($is_insured_8) echo "checked";?>>
      </div></td>
    </tr>

    <tr>
      <td class="td_content">9</td>
      <td class="td_content">
      <input type="text" name="short_9" value="<?php echo $short_9;?>" size="20"/>      </td>
      <td class="td_content"><input type="text" name="long_9" value="<?php echo $long_9;?>" size="40"/></td>
      <td class="td_content"><div align="center">
        <input type="checkbox" name="is_insurance" value="9" <?php if ($is_insured_9) echo "checked";?>>
      </div></td>
    </tr>
    ...
    <tr>
      ...
      <td class="td_content">
      <input type="text" name="short_10" value="<?php echo $short_10;?>" size="20"/>      </td>
      <td class="td_content"><input type="text" name="long_10" value="<?php echo $long_10;?>" size="40"/></td>
      <td class="td_content"><div align="center">
        <input type="checkbox" name="is_insurance" value="10" <?php if ($is_insured_10) echo "checked";?>>
      </div></td>
    </tr>

     <tr>
      <td class="td_content">11</td>
      <td class="td_content">
      <input type="text" name="short_11" value="<?php echo $short_11;?>" size="20"/>      </td>
      <td class="td_content"><input type="text" name="long_11" value="<?php echo $long_11;?>" size="40"/></td>
      <td class="td_content"><div align="center">
        <input type="checkbox" name="is_insurance" value="11" <?php if ($is_insured_11) echo "checked";?>>
      </div></td>
    </tr>

    <tr>
      <td class="td_content">12</td>
      <td class="td_content">
      <input type="text" name="short_12" value="<?php echo $short_12;?>" size="20"/>      </td>
      <td class="td_content"><input type="text" name="long_12" value="<?php echo $long_12;?>" size="40"/></td>
      <td class="td_content"><div align="center">
        <input type="checkbox" name="is_insurance" value="12" <?php if ($is_insured_12) echo "checked";?>>
      </div></td>
    </tr>
