              ...
              <tr>
                ...
                <td class="product_price"><p>
                  ...
                  <p>
                    ...
                    <p>
                      <input type="text" name="selians_item_price_7" value="<?php echo $selians_item_price_7;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_8; ?></p>

                       <p>
                      <input type="text" name="selians_item_price_8" value="<?php echo $selians_item_price_8;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_9; ?></p>

                       <p>
                      <input type="text" name="selians_item_price_9" value="<?php echo $selians_item_price_9;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_10; ?></p>

                       <p>
                      <input type="text" name="selians_item_price_10" value="<?php echo $selians_item_price_10;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_11; ?></p>

                       <p>
                      <input type="text" name="selians_item_price_11" value="<?php echo $selians_item_price_11;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_12; ?></p>
