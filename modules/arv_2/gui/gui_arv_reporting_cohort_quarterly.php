...
require_once $root_path . 'main_theme/reportingNav.inc.php';
            ...
            <form method="get" action="" name="select_form">
                ...
                <div class="timeframe">
                    ...
                    <select name="quarter" size="1">
                        <option <?php if (@$_GET['quarter'] && $_GET['quarter'] == 1) {
		echo "selected=\"selected\"";
	}
	?> value="1">Jan-March</option>
                        <option <?php if (@$_GET['quarter'] && $_GET['quarter'] == 4) {
		echo "selected=\"selected\"";
	}
	?> value="4">April-June</option>
                        <option <?php if (@$_GET['quarter'] && $_GET['quarter'] == 7) {
		echo "selected=\"selected\"";
	}
	?> value="7">Jul-Sept</option>
                        <option <?php if (@$_GET['quarter'] && $_GET['quarter'] == 10) {
		echo "selected=\"selected\"";
	}
	?> value="10">Oct-Dec</option>
                    </select>
                    Year
	...
	?> value="<?php echo $curr_year - 2; ?>"> <?php echo $curr_year - 2; ?></option>
                    ...
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 6) {
		echo "selected=\"selected\"";
	}
	?> value="6">6</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 12) {
		echo "selected=\"selected\"";
	}
	?> value="12">12</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 24) {
		echo "selected=\"selected\"";
	}
	?> value="24">24</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 36) {
		echo "selected=\"selected\"";
	}
	?> value="36">36</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 48) {
		echo "selected=\"selected\"";
	}
	?> value="48">48</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 60) {
		echo "selected=\"selected\"";
	}
	?> value="60">60</option>
                    <option <?php if (@$_GET['period'] && $_GET['period'] == 72) {
		echo "selected=\"selected\"";
	}
	?> value="72">72</option>
                    </select>&nbsp; months
