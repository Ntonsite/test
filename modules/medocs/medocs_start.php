...
$origin=isset($origin) ? : null;
$thisfile = basename($_SERVER['PHP_SELF']);
if ($origin == 'patreg_reg')
    $returnfile = 'patient_register_show.php' . URL_APPEND . '&pid=' . $pid;

# Set break file
require('include/inc_breakfile.php');
$_SESSION['sess_en']=isset($_SESSION['sess_en']) ? : null;
$_SESSION['sess_pid']=isset($_SESSION['sess_pid']) ? : null;
$_SESSION['sess_full_en']= isset($_SESSION['sess_full_en']) ? : null;
$_SESSION['sess_full_pid']= isset($_SESSION['sess_full_pid']) ? : null;
