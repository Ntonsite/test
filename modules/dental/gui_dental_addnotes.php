            ...
            <tr>
                <td><table width="470"  border="0" align="center" cellpadding="4" cellspacing="1" bgcolor="#D2DFD0" class="style3">
                        <tr align="center" bgcolor="#E7EEE6">
                            <td height="38" colspan="3" bgcolor="#C0D2BD"><div align="center" class="style5" style="text-transform:uppercase;"><?php print(@$_GET['mode'] && $_GET['mode'] == 'edit') ? $mode : ' Add';?> Patient notes</div></td>
                        </tr>
                        <tr bgcolor="#E7EEE6">
                        ...
                        <tr align="center" valign="top" bgcolor="#FFFFFF">
                            ...
                            <td width="265" align="left" nowrap bgcolor="#FFFFFF" class="style7">
                                <textarea name="notes" required="" style="font-size: 15pt" cols="50" rows="10" id="notes"><?php print $yy[3] ?? "";?></textarea>
                            </td>
