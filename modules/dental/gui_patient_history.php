...
<html>
    <head>
        <title><?php echo $pName->GetPatientNameFromPid($pid) . '- ' . $LDHeadHistory; ?></title>
    ...
    <table width=100% border=0 height=100% cellpadding="0" cellspacing="0">
        <tr valign=top><td bgcolor="<?php echo $cfg['top_bgcolor']; ?>" height="10">
            ...
            <td bgcolor="<?php echo $cfg['top_bgcolor']; ?>" height="10" align='right' style='padding-top:5px;'>
             ...
             <?php
             $_SESSION['dept_nr']=isset($_SESSION['dept_nr'])? $_SESSION['dept_nr'] : "";
             ?>
...
?></a>
                ...
                <a href="javascript:gethelp('dental.php')"><img <?php echo createLDImgSrc($root_path, 'hilfe-r.gif', '0') ?>  <?php if ($cfg['dhtml']) {
        ...
        <tr align="left" valign="top">
            <td colspan="2" style="padding-top:9px;">
                ...
                <table width="590"  border="1" align="center" cellpadding="4" cellspacing="1" bgcolor="#A6BFA2" class="style3">
                    ...
                    <?php $histry->PrintPatientNotes($pid, $encounter_nr, $LDNoRecordFound, $c1, $c2, $records);?>
