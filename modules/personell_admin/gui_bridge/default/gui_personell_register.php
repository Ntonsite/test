...
<BODY bgcolor="<?php echo $cfg['body_bgcolor']; ?>" topmargin=0 leftmargin=0 marginwidth=0 marginheight=0 <?php
																											if (!$personell_nr && !$pid) {
																											?> onLoad="if(document.searchform.searchkey.focus) document.searchform.searchkey.focus();" <?php
																											}
						...
						<form method="post" action="<?php echo $thisfile; ?>" name="aufnahmeform" onSubmit="return chkForm(this)">
							...
							<table border="0" cellspacing=1 cellpadding=0 width=450>
								...
								<tr>
									...
									<td class="adm_input">
										<FONT color="#800000">&nbsp;<?php //if($date_exit!='0000-00-00') echo @formatDate2Local($date_exit,$date_format);  
																	?>
									</td>
								</tr>
								...
								<tr>
									...
									<td bgcolor="#ffffee">&nbsp;<FONT color="#800000"><?php if ($sex == 'm') echo $LDMale;
...
-->
								...
								<tr>
									...
									<td colspan=2 class="adm_input"><input name="date_join" type="text" size="12" maxlength=10 value="<?php if (isset($date_join) && $date_join != DBF_NODATE)   echo formatDate2Local($date_join, $date_format); ?>" onFocus="this.select();" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
								...
								<tr>
									...
									<td colspan=2 class="adm_input"><input name="date_exit" type="text" size="12" maxlength=10 value="<?php if (isset($date_exit) && $date_exit != DBF_NODATE)   echo formatDate2Local($date_exit, $date_format); ?>" onFocus="this.select();" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
								...
								<tr>
									...
									<td colspan=2 class="adm_input"><input name="contract_start" type="text" size="12" maxlength=10 value="<?php if (isset($contract_start) && $contract_start != DBF_NODATE)   echo formatDate2Local($contract_start, $date_format); ?>" onFocus="this.select();" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
								...
								<tr>
									...
									<td colspan=2 class="adm_input"><input name="contract_end" type="text" size="12" maxlength=10 value="<?php if (isset($contract_end) && $contract_end != DBF_NODATE)   echo formatDate2Local($contract_end, $date_format); ?>" onFocus="this.select();" onBlur="IsValidDate(this,'<?php echo $date_format ?>')" onKeyUp="setDate(this,'<?php echo $date_format ?>','<?php echo $lang ?>')">
								...
								<tr>
									...
									<td colspan=2 class="adm_input"><input name="encoder" type="text" value="<?php if ($create_id) echo $create_id;
																												else echo $_SESSION['sess_user_name']; ?>" size="30">
										</nobr>
									</td>
								</tr>
