...
if ($update)
    $breakfile = 'personell_register_show.php' . URL_APPEND . '&personell_nr=' . $personell_nr;
...
require('./gui_bridge/default/gui_personell_register.php');
