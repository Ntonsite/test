...
//<!--
            function gethelp(x, s, x1, x2, x3, x4)
            {
                ...
                helpwin = window.open(urlholder, "_self");
            }
                    ...
                    <table cellspacing="0"  class="titlebar" border=0 cellpadding="0" cellspacing="0">
                        <tr valign=top  class="titlebar" >
                            ...
                            <td bgcolor="#99ccff" align=right>
                                <?php
$comming_from = (isset($comming_from) ? $comming_from : null);
...
<!--                      <a href="pharmacy_tz_pending_prescriptions.php?&mode=done&discharge=true&encounter=' . $pn . '&pn=' . $pn . '&prescription_date=' . $prescription_date . '>"><img src="../../gui/img/control/default/en/en_done_and_discharge.gif" border=0 align="absmiddle" width="175" height="24" alt="Its done! Move the form to the archive and discharge our patient"></a> -->
                      <br>
                     ';
}
