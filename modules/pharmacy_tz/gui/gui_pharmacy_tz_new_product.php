...
<tbody class="main">
 ...
 <tr valign=top  class="titlebar" >
  ...
  <td bgcolor="#99ccff" align=right><a
   ...
   href="../../modules/pharmacy_tz/pharmacy_tz_product_catalog.php" ><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>  </td>
 </tr>
 </table>		</td>
	</tr>
<?php
    //I can't figure out why  $GLOBAL_CONFIG['out_of_stock'] is not returned. Im writing query for it
                    $sql_price_readony="SELECT value FROM care_config_global WHERE type='price_readonly'";
                    $result_readonly=$db->Execute($sql_price_readony);
                    if ($row_readonly=$result_readonly->FetchRow()) {
                        $price_readonly=$row_readonly['value'];
...
<font class="prompt"><?php if (!isset($ERROR)) echo $MSG; ?>&nbsp;</font>

<font class="warnprompt">
                              <?php if (isset($ERROR)) echo $ERROR_MSG?><br>
                              <?php if (isset($DELETE_FORM)) echo "WARNING! If you press OK, this item with code \"".$selian_item_number."\" will be deleted!<br>"?>
</font>
...
function CheckCategory(){
  var CatSelected;
  var SubCat;
  CatSelected=document.getElementById('purchasing_class').value;
  SubCat=document.getElementById('item_subclass').value;
  if(CatSelected==""){
    alert("Item Classification Missing");
    purchasing_class.focus();
    return false;
  }else{
    if (SubCat=="") {
      alert("Select Item Subcategory"); 
      return false;    
...
<form ENCTYPE="multipart/form-data" action="pharmacy_tz_new_product.php" method="get" name="inputform" onsubmit="return CheckCategory();" >
            ...
            <tbody class="submenu">
              <tr>
                ...
                <td align=right width=145 >
                                           <?php if (isset($ERROR_SELIAN_ITEM_NUMBER)) echo '<font color="red">';?>
                                              <?php echo $LDSelianItemNumber; ?>
                                           <?php if (isset($ERROR_SELIAN_ITEM_NUMBER)) echo '</font>';?>                </td>
	      ...
	      <tr>
              ...
              <tr>
                ...
                <td align=right>&nbsp;</td>
                <td align=right>
                                          <?php if (isset($ERROR_SELIANS_ITEM_DESCRIPTION)) echo '<font color="red">';?>
                                            <?php echo $LDSeliansItemDesc; ?></td>
                                          <?php if (isset($ERROR_SELIANS_ITEM_DESCRIPTION)) echo '</font>';?>
              ...
              <tr>
                ...
                if (isset($html_disabler)) {
                          echo $item_classification;
                      } else { ?>
                  <select name="purchasing_class" id="purchasing_class">
      ...
      <!-- $item_subclass-->
                ...
                <option value="tabs" <?PHP if ($item_subclass=="tabs") echo "selected";?>>tabs</option>
                <option value="injections" <?PHP if ($item_subclass=="injections") echo "selected";?>>injections</option>
              ...
              <tr>
                ...
                <td class="product_price"><p>
                    <input type="text" <?php echo $readonly;?> name="selians_item_price" value="<?php echo $selians_item_price;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                    <?php echo $short_1; ?></p>
                    <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_1" value="<?php echo $selians_item_price_1;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_2; ?></p>
                  <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_2" value="<?php echo $selians_item_price_2;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_3; ?></p>
                  <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_3" value="<?php echo $selians_item_price_3;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_4; ?></p>


                  <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_4" value="<?php echo $selians_item_price_4;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_5; ?></p>

                  <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_5" value="<?php echo $selians_item_price_5;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_6; ?></p>

                  <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_6" value="<?php echo $selians_item_price_6;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_7; ?></p>

                    <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_7" value="<?php echo $selians_item_price_7;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_8; ?></p>

                       <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_8" value="<?php echo $selians_item_price_8;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_9; ?></p>

                       <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_9" value="<?php echo $selians_item_price_9;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_10; ?></p>

                       <p>
                      <input type="text" <?php echo $readonly;?> name="selians_item_price_10" value="<?php echo $selians_item_price_10;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                      <?php echo $short_11; ?></p>

                      <p>
                        <input type="text" <?php echo $readonly;?> name="selians_item_price_11" value="<?php echo $selians_item_price_11;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                        <?php echo $short_12; ?>
                      </p>

                      <p>
                        <input type="text" <?php echo $readonly;?> name="selians_item_nhif_item_code" value="<?php echo $selians_item_nhif_item_code;?>" <?php echo $html_disabler;?> size=20 maxlength=40>
                        NHIF Item Code
                      </p>

                      <p>
                        <select name="selians_item_nhif_is_restricted" style="width: 130px;">
                          <option <?php if($selians_item_nhif_is_restricted == 0){echo 'selected'; } ?> value="0">No</option>
              ...
              <tr>
                ...
                <td width=30 align=right class="classification">&nbsp;</td>
                <td align=right width=32>&nbsp;</td>
                <td align=right class="product_price"></td>
                <td class="product_price" style="padding-bottom: 40px;">
                  <i class="material-icons" onclick="appendSchemeItem()" style="color: green; font-size: 30px; cursor: pointer; margin-bottom: 10px;">add_circle</i>
                  <div id="schemeContainer">
                    <?php if (@$schemeItems): ?>
                      <?php foreach ($schemeItems as $itemKey => $schemeItem): ?>
                        <div id="schemerow<?php  echo $itemKey ?>">
                        <input type="text" name="nhif_schemes[]" style="margin-top: 10px;" value="<?php echo $schemeItem['scheme_id'] ?>" placeholder="NHIF Scheme" size=20 maxlength=40><button type="button" onclick="removeSchemeItem(<?php echo $itemKey ?>)" class="btn btn-info btn-sm" >Remove</button> <br>
                      </div>
                      <?php endforeach ?>
                    <?php else: ?>
                      <input type="text" name="nhif_schemes[]" placeholder="NHIF Scheme" size=20 maxlength=40>
                    <?php endif ?>
                  </div>
                </td>
              </tr> -->
              ...
              <tr>
                ...
                <?php if (isset($GO_BACK_TO_SEARCH))
          ...
          <a href="pharmacy_tz_product_catalog.php"><img src="../../gui/img/control/default/en/en_cancel.gif" border=0 align="left" width="103" height="24" alt="Go back to databank menu"></a>
...
<script type="text/javascript">
  function appendSchemeItem() {
    var number = Math.floor((Math.random() * 10) + 1);

    $("#schemeContainer").append('<br><div id="schemerow'+number+'"><input style="margin-top: 10px;" type="text" name="nhif_schemes[]" placeholder="NHIF Scheme" size=20 maxlength=40><button type="button" onclick="removeSchemeItem('+number+')" class="btn btn-info btn-sm" >Remove</button>');
  }

  function removeSchemeItem(itemIndex) {

    $("#schemerow"+itemIndex).remove()
  }
</script>