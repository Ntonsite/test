...
// -->
        ...
        function popPic(pid, nm) {
            ...
            function open_bulk_dispense(admission_type) {
                urlholder = "<?php echo $root_path; ?>modules/pharmacy_tz/pharmacy_tz_bulk_dispense.php?sid=<?php echo $sid . "&lang=" . $lang; ?>&prescrServ=prescr&admission=" + admission_type + "&comming_from=pharmacy&loccode=<?php echo $loccode; ?>&locname=<?php echo $locname; ?>";
                window.open(urlholder , '_self');
                        ...
                        <table cellspacing="0"  class="titlebar" border=0>
                            <tr valign=top  class="titlebar" >
                                ...
                                <td bgcolor="#99ccff" align=right><a
                                        ...
                                        href="pharmacy_tz_substore.php" ><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this, 1)" onMouseOut="hilite(this, 0)"></a>  </td>
                            </tr>
<?php //echo $_SESSION['substore']; ?>
        ...
        <p>
            <a href="pharmacy_tz_substore.php"><img src="../../gui/img/control/default/en/en_close2.gif" border=0 width="103" height="24" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this, 1)" onMouseOut="hilite(this, 0)"></a>
