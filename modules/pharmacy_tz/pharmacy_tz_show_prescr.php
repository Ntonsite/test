...
if (isset($_GET['save'])) {
	...
	if (($insurance_ID != '') && !$insuranceParentSame && (!$wrong_max_pay)) {
		...
		if ($name == '') {
			...
			// does name of the insurance already exist?
...
require "gui/gui_pharmacy_tz_show_prescr.php";
