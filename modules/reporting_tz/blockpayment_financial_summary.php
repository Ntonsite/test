...
//BLOCK PAYMENT IS WRITTEN BY ISRAEL PDESCAL
//ELCT ICT UNIT 
//israel.pDESCal10@gmail.com, +255719709660, +255767809660
?>
...
<script language="javDESCript" src="../../js/datetimepicker.js"></script>
                ...
                <table width="770" border=0 align="center" cellspacing="0"  class="titlebar">
                    <tr valign=top  class="titlebar" >
                        ...
                        <td width="238" align=right bgcolor="#99ccff">
                            <a href="javDESCript: history.back();"><img src="../../gui/img/control/default/en/en_back2.gif" /></a>
                ...
                <form id="form1" name="form1" method="post" action="">
                    <table width="596" border="0" align="center" bgcolor="#CCCCFF">
                        <tr>
                            ...
                            <td width="98"><a href="javDESCript:NewCal('dfrom','ddmmyyyy')"><img src="../../gui/img/common/default/calendar.gif" /></a></td>
                            <td width="47">TO:</td>
                            <td width="144"><input type="text" id="dto" name="dto"/></td>
                            <td width="56"><a href="javDESCript:NewCal('dto','ddmmyyyy')"><img src="../../gui/img/common/default/calendar.gif" /></a><td>Type</td></td>
                            <td><?php
