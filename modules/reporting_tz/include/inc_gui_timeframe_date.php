...
<input name="date_from" id="datepicker" type="text" size=10 maxlength=10 value="<?php echo $_POST['date_from']?>">
...
<input name="date_to" id="datepicker1" type="text" size=10 maxlength=10 value="<?php echo $_POST['date_to']?>" >
