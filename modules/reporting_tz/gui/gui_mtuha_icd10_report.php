                ...
                <?php 
                 ...
                 ?>
                        ...
                        <form name="form1" method="POST" action="">                       
                            ...
                            require_once($root_path . $top_dir . 'include/inc_gui_timeframe _date_range.php'); 
                            ...
                            <label>
                                ...
                                <input type="text" name="dx" placeholder="diagnosis name">
                                
                            </label>
                            <label>
                                <input type="text" name="dxCode" placeholder="ICD 10 code">
                            ...
                            <table width="750" border="1" cellspacing="0" cellpadding="0" align="center" bgcolor=#ffffdd>
                                ...
                                <?php
                                $start=strtotime($_POST['date_from']);
