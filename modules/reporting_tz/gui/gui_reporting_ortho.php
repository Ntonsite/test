...
<meta http-equiv="Content-Type" content="text/html; charset=iso-8859-1">
    ...
    <?php
$rep_obj->Ortho_Revenue($_GET['start'], $_GET['end'], $_GET['company'], $_GET['in_out_patient'], $_GET['dept_nr'], $_GET['insurance'], 1);
     exit();
}
?>
...
<!-- 
            ...
            {
                urlholder = "./ortho_surgeries_report.php?printout=TRUE&start=<?php echo $selected_date_from; ?>&end=<?php echo $selected_date_to; ?>&company=<?php echo $company; ?>&in_out_patient=" + admission_id + "&dept_nr=" + dept + "&insurance=" + insurance;
 ...
 ?>
                        ...
                        <form name="form1" method="post" action="" onSubmit="javascript:validate()">        
                            ...
                            if (isset($_POST['show'])) {
                                ...
                                $rep_obj->Ortho_Revenue($selected_date_from, $selected_date_to, $company, $_POST['admission_id']);
                            }
                            ?>
                            <!-- &nbsp;&nbsp;
