...
/* The following routine creates the list of pending requests */
	...
	?></td>
            ...
            <td>
                ...
                <?php
if (@$stored_request && $stored_request['release_via'] != '' && $stored_request['mainlog_sign'] != '' && $stored_request['status'] != 'done') {
		?>
                                                                ...
                                                                <table border=0 bgcolor="<?php echo $bgc1 ?>" cellpadding=4 width=100%>
                                                                    <tr  class=fva2_ml10>
                                                                        <td><?php echo $LDBloodGroup ?><br>
                                                                            <font  size=2 color="#ff0000"><b><?php if ($stored_request['blood_group']) {
		echo $stored_request['blood_group'];
	}
	?></b></font></td>
                                                                        <td><?php echo $LDRhFactor ?><br>
                                                                            <font  size=2 color="#ff0000"><b><?php if ($stored_request['rh_factor']) {
		echo $stored_request['rh_factor'];
	}
	?></b></font></td>
                                                                        <td><?php echo $LDKell ?><br>
                                                                            <font  size=2 color="#ff0000"><b><?php if ($stored_request['kell']) {
		echo $stored_request['kell'];
	}
	?></b></font></td>
                                                                    </tr>
                                                                    <tr class=fva0_ml10>
                                                                        <td colspan=3><?php echo $LDDateProtNumber ?><br>
                                                                            <font  size=2 color="#0000ff"><?php if ($stored_request['date_protoc_nr']) {
		echo $stored_request['date_protoc_nr'];
	}
	?></font></td>
                                                                    </tr>
                                                                </table>
...
if ($edit || $read_form) {
                                                            ...
                                                            <td>
                                                                <table border=0 cellpadding=1 cellspacing=1 width=100% height=100%>
                                                                    ...
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        ...
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['pure_blood']) {
		echo $stored_request['pure_blood'];
	}
	?></td>
                                                                    </tr>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDRedBloodCon ?></td>
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['red_blood']) {
		echo $stored_request['red_blood'];
	}
	?></font></td>
                                                                    </tr>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDLeukoLessRedBlood ?></td>
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['leukoless_blood']) {
		echo $stored_request['leukoless_blood'];
	}
	?></font></td>
                                                                    </tr>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDWashedRedBlood ?></td>
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['washed_blood']) {
		echo $stored_request['washed_blood'];
	}
	?></font></td>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDPRP ?></td>
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['prp_blood']) {
		echo $stored_request['prp_blood'];
	}
	?></font></td>
                                                                    </tr>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDThromboCon ?></td>
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['thrombo_con']) {
		echo $stored_request['thrombo_con'];
	}
	?></font></td>
                                                                    </tr>
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        <td>&nbsp;<?php echo $LDFFP ?></td>
                                                                        <td ><font  size=2 color="#0000ff"><?php if ($stored_request['ffp_plasma']) {
		echo $stored_request['ffp_plasma'];
	}
	?></font></td>
                                                                    </tr>
                                                                    ...
                                                                    <tr  class=fva2_ml10 bgcolor="<?php echo $bgc1 ?>" >
                                                                        ...
                                                                        <td><font  size=2 color="#0000ff"><?php if ($stored_request['transfusion_dev']) {
		echo $stored_request['transfusion_dev'];
	}
	?></font></td>
                                                                    </tr>
                                                                </table>
                                                ...
                                                <td  bgcolor="<?php echo $bgc1 ?>" >
                                                    ...
                                                    <table border=0 cellspacing cellpadding=0>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><font face="arial" size=2 color="#0000ff"><?php if ($stored_request['transfusion_date'] && $stored_request['transfusion_date'] != DBF_NODATE) {
		echo formatDate2Local($stored_request['transfusion_date'], $date_format);
	}
	?></font></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan=2><div class=fva2b_ml10><b><?php echo $LDDiagnosis ?></b><br><img src="../../gui/img/common/default/pixel.gif" border=0 width=10 height=30 align="left">
                                                                    <font face="arial" size=2 color="#0000ff"><?php if ($stored_request['diagnosis']) {
		echo stripslashes($stored_request['diagnosis']);
	}
	?></font></div></td>
                                                        </tr>
                                                        <tr>
                                                            <td colspan=2> <div class=fva2b_ml10><font size=1><?php echo $LDNotesRequests ?></font><br><img src="../../gui/img/common/default/pixel.gif" border=0 width=10 height=30 align="left">
                                                                    <font face="arial" size=2 color="#0000ff"><?php if ($stored_request['notes']) {
	...
	?></font></div></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><font face="arial" size=2 color="#0000ff"><?php if ($stored_request['doctor']) {
		echo $stored_request['doctor'];
	}
	?></font></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><div class=fva2b_ml10><font size=1><?php echo $LDTelephone ?>:&nbsp;</font></div></td>
                                                            <td><font face="arial" size=2 color="#0000ff"><?php if ($stored_request['phone_nr']) {
		echo $stored_request['phone_nr'];
	}
	?></font></td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <td bgcolor="#000000" valign="top" colspan=3>
                                                    ...
                                                    <table border=0 cellspacing=1 width=100% height=100% align="left" cellpadding=0>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            ...
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_pb" size=90 maxlength=90 <?php if ($stored_request['blood_pb']) {
		echo 'value="' . $stored_request['blood_pb'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDRB ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_rb" size=90 maxlength=90 <?php if ($stored_request['blood_rb']) {
		echo 'value="' . $stored_request['blood_rb'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDLLRB ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_llrb" size=90 maxlength=90 <?php if ($stored_request['blood_llrb']) {
		echo 'value="' . $stored_request['blood_llrb'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDWRB ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_wrb" size=90 maxlength=90 <?php if ($stored_request['blood_wrb']) {
		echo 'value="' . $stored_request['blood_wrb'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDPRP_Initial ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_prp" size=90 maxlength=90 <?php if ($stored_request['blood_prp']) {
		echo 'value="' . $stored_request['blood_prp'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDTC ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_tc" size=90 maxlength=90 <?php if ($stored_request['blood_tc']) {
		echo 'value="' . $stored_request['blood_tc'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>">
                                                            <td width=100 align="center"><font size=2 face="arial"><?php echo $LDFFP_Initial ?></font></td>
                                                            <td  colspan=7>&nbsp;<input type="text" name="blood_ffp" size=90 maxlength=90 <?php if ($stored_request['blood_ffp']) {
		echo 'value="' . $stored_request['blood_ffp'] . '"';
	}
	?>></td>
                                                        </tr>
                                                        <tr bgcolor="<?php echo $bgc1 ?>" valign="top">
...
if ($stored_request['lab_stamp'] && $stored_request['lab_stamp'] != DBF_NODATETIME) {
		echo formatDate2Local($stored_request['lab_stamp'], $date_format) . ' ' . convertTimeToLocal(formatDate2Local($stored_request['lab_stamp'], $date_format, 0, 1));
	} else {
		echo formatDate2Local(date('Y-m-d H:i:s'), $date_format) . ' ' . convertTimeToLocal(formatDate2Local(date('Y-m-d H:i:s'), $date_format, 0, 1));
	}
...
if ($stored_request['lab_stamp'] && $stored_request['lab_stamp'] != DBF_NODATETIME) {
	...
	?>">
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>" >
                                                ...
                                                <td><input type="text" name="b_group_count" size=5 maxlength=5 <?php if ($stored_request['b_group_count']) {
		echo 'value="' . $stored_request['b_group_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                ...
                                                <td><input type="text" name="a_subgroup_count" size=5 maxlength=5 <?php if ($stored_request['a_subgroup_count']) {
		echo 'value="' . $stored_request['a_subgroup_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>" valign="top">
                                                ...
                                                <td><input type="text" name="extra_factors_count" size=5 maxlength=5 <?php if ($stored_request['extra_factors_count']) {
		echo 'value="' . $stored_request['extra_factors_count'] . '"';
	}
	?>></td>
                                                ...
                                                <td colspan=2 rowspan=4>&nbsp;<font size=1 face="arial"><?php echo $LDReleaseVia ?><br>
                                                    &nbsp;<input type="text" name="release_via" size=17 maxlength=20 <?php if ($stored_request['release_via']) {
		echo 'value="' . $stored_request['release_via'] . '"';
	}
	?>></td>
                                                <td colspan=2 rowspan=4>&nbsp;<font size=1 face="arial"><?php echo $LDReceiptAck ?><br>
                                                    &nbsp;<input type="text" name="receipt_ack" size=17 maxlength=20 <?php if ($stored_request['receipt_ack']) {
		echo 'value="' . $stored_request['receipt_ack'] . '"';
	}
	?>></td>
                                            </tr>
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                ...
                                                <td><input type="text" name="coombs_count" size=5 maxlength=5 <?php if ($stored_request['coombs_count']) {
		echo 'value="' . $stored_request['coombs_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                ...
                                                <td><input type="text" name="ab_test_count" size=5 maxlength=5 <?php if ($stored_request['ab_test_count']) {
		echo 'value="' . $stored_request['ab_test_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                ...
                                                <td><input type="text" name="crosstest_count" size=5 maxlength=5 <?php if ($stored_request['crosstest_count']) {
		echo 'value="' . $stored_request['crosstest_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                ...
                                                <td><input type="text" name="ab_diff_count" size=5 maxlength=5 <?php if ($stored_request['ab_diff_count']) {
		echo 'value="' . $stored_request['ab_diff_count'] . '"';
	}
	?>></td>
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                <td><input type="text" name="x_test_1_code" size=4 maxlength=4 <?php if ($stored_request['x_test_1_code']) {
		echo 'value="' . $stored_request['x_test_1_code'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_1_name" size=20 maxlength=25 <?php if ($stored_request['x_test_1_name']) {
		echo 'value="' . $stored_request['x_test_1_name'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_1_count" size=5 maxlength=5 <?php if ($stored_request['x_test_1_count']) {
		echo 'value="' . $stored_request['x_test_1_count'] . '"';
	}
	?>></td>
                                                ...
                                                <td><input type="text" name="mainlog_nr" size=8 maxlength=8 <?php if ($stored_request['mainlog_nr']) {
		echo 'value="' . $stored_request['mainlog_nr'] . '"';
	}
	?>></td>
                                                <td>&nbsp;<font size=1 face="arial"><?php echo $LDLabNumber ?></td>
                                                <td><input type="text" name="lab_nr" size=8 maxlength=8 <?php if ($stored_request['lab_nr']) {
		echo 'value="' . $stored_request['lab_nr'] . '"';
	}
	?>></td>
                                            </tr>
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                <td><input type="text" name="x_test_2_code" size=4 maxlength=4 <?php if ($stored_request['x_test_2_code']) {
		echo 'value="' . $stored_request['x_test_2_code'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_2_name" size=20 maxlength=25 <?php if ($stored_request['x_test_2_name']) {
		echo 'value="' . $stored_request['x_test_2_name'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_2_count" size=5 maxlength=5 <?php if ($stored_request['x_test_2_count']) {
		echo 'value="' . $stored_request['x_test_2_count'] . '"';
	}
	?>></td>
                                                ...
                                                <td><input type="text" id="datepicker" name="mainlog_date" size=8 maxlength=10  value="<?php if ($stored_request['mainlog_date'] != DBF_NODATE) {
	...
	?>"  onBlur="IsValidDate(this, '<?php echo $date_format ?>')"  onKeyUp="setDate(this, '<?php echo $date_format ?>', '<?php echo $lang ?>')">
                                                ...
                                                <td><input type="text" id="datepicker" name="lab_date" size=8 maxlength=10  value="<?php if ($stored_request['lab_date'] != DBF_NODATE) {
	...
	?>"  onBlur="IsValidDate(this, '<?php echo $date_format ?>')"   onKeyUp="setDate(this, '<?php echo $date_format ?>', '<?php echo $lang ?>')">
                                            ...
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                <td><input type="text" name="x_test_3_code" size=4 maxlength=4 <?php if ($stored_request['x_test_3_code']) {
		echo 'value="' . $stored_request['x_test_3_code'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_3_name" size=20 maxlength=25 <?php if ($stored_request['x_test_3_name']) {
		echo 'value="' . $stored_request['x_test_3_name'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_3_count" size=5 maxlength=5 <?php if ($stored_request['x_test_3_count']) {
		echo 'value="' . $stored_request['x_test_3_count'] . '"';
	}
	?>></td>
                                                <td><input type="text" name="x_test_3_price" size=7 maxlength=7 <?php echo 'value="' . $stored_request['x_test_3_price'] . '"'; ?>></td>
                                                <td colspan=2>&nbsp;<input type="text" name="mainlog_sign" size=17 maxlength=20 <?php if ($stored_request['mainlog_sign']) {
		echo 'value="' . $stored_request['mainlog_sign'] . '"';
	}
	?>></td>
                                                <td colspan=2>&nbsp;<input type="text" name="lab_sign" size=17 maxlength=20 <?php if ($stored_request['lab_sign']) {
		echo 'value="' . $stored_request['lab_sign'] . '"';
	}
	?>></td>
                                            </tr>
                                            <tr bgcolor="<?php echo $bgc1 ?>">
                                                <td colspan=3>&nbsp;<font size=1 face="arial"><?php echo $LDTotalAmount ?></td>
                                                <td><input type="text" name="total_amount" size=7 maxlength=20 <?php echo 'value="' . ($stored_request['b_group_price'] + $stored_request['a_subgroup_price'] + $stored_request['extra_factors_price'] + $stored_request['coombs_price'] + $stored_request['ab_test_price'] + $stored_request['crosstest_price'] + $stored_request['ab_diff_price'] + $stored_request['x_test_1_price'] + $stored_request['x_test_2_price'] + $stored_request['x_test_3_price']) . '"'; ?>></td>
                                                <td colspan=2>&nbsp;<font size=1 face="arial"><?php echo $LDSignature ?></td>
                                                <td colspan=2>&nbsp;<font size=1 face="arial"><?php echo $LDSignature ?></td>
                                            </tr>
