...
if ($edit || $read_form) {
	...
	?></td>
                                                    <td bgcolor="<?php echo $bgc1 ?>"  class=fva2_ml10><div   class=fva2_ml10><font size=5 color="#0000ff"><b><?php echo $formtitle ?></b></font>
                                                            ...
                                                            <?php if (@$stored_request['hint']): ?>
                                                            <tr style="margin-top: 0px; display: inline-block; ">
                                                                <td colspan="">
                                                                    <p style="margin-bottom: 0;">Hint:</p>
                                                                    <div class="alert alert-info" style="padding-top: 5px; padding-bottom: 5px; font-size: 14px; box-shadow: none; width: 300px;" role="alert">
                                                                        <?php echo $stored_request['hint']; ?>
                                                                    </div>
                                                                </td>
                                                            </tr>
                                                            <?php endif?>
	...
	?></font>&nbsp;
                    ...
                    <font face="courier" size=2 color="#000000">&nbsp;<?php echo $stored_request['send_doctor'] ?></font></div><br>
                       ...
                       <tr bgcolor="<?php echo $bgc1 ?>">
                        ...
                        <input type="text" name="xray_nr" value="<?php if ($read_form && $stored_request['xray_nr']) {
		echo $stored_request['xray_nr'];
	}
	?>" size=9 maxlength=9>
                                <?php echo $LD_r_cm2 ?>
                                <input type="text" name="r_cm_2" value="<?php if ($read_form && $stored_request['r_cm_2']) {
		echo $stored_request['r_cm_2'];
	}
	?>" size=7 maxlength=15>
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <?php echo $LDXrayTechnician ?>&nbsp;
                                        <input type="text" name="mtr" value="<?php if ($read_form && $stored_request['mtr']) {
		echo $stored_request['mtr'];
	}
                                                                    ...
                                                                    <tr bgcolor="<?php echo $bgc1 ?>">
                                                                        <td colspan=2>
                                                                            <div class=fva2_ml10>&nbsp;<br><font color="#000099"><?php echo $LDNotesTempReport ?></font><br>
                                                                                <textarea name="results" cols=80 rows=5 wrap="physical"><?php if ($read_form && $stored_request['results']) {
		echo stripslashes($stored_request['results']);
	}
	?></textarea>
                                                                        </td>
                                                                    </tr>
