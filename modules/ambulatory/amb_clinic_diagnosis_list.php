...
$dept = @($_GET['dept']) ? $_GET['dept'] : $_POST['dept'] ?? "";
$station = $dept;
$dept_nr = $dept_nr ?? "";
...
?>
                                    ...
                                    <TR>
                                        <TD bgcolor=#ffffff align="center">
                                            <b>Filter by Date: </b>
                                            <!--</TD><TD>-->
                                            <input name="prescr_date" id="datepicker1" class="datepicker" type="text" size="15" maxlength=10 value="<?php {
	echo $prescr_date;
}
?>"
                                                   onFocus="this.select();"
...
//                                                    echo 'lk;lk';
//                                                    echo $dept_nr;
$sqlOuter = "select * from care_encounter WHERE current_dept_nr=$dept_nr";

$coreObjOuter->result = $db->Execute($sqlOuter);

if (@$coreObjOuter->result) {
