...
// echo '<pre>'; print_r($prescr_date); echo "</pre>";die;
                                                ...
                                                <TBODY class="submenu">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="submenu_item"><?php echo $LDTimesPerDay ?></td>
                                                         <td class="submenu_item">Total Dosage</td>
...
foreach ($coreObjOuter->result as $rowEncounter) {
	...
	foreach ($coreObjInner->result as $rowPrescr) {
		...
		if ($prescr == '') {
			...
			$prescr .= '<tr><td>&nbsp;</td><td>&nbsp;</td><td></td><td>';
		}
		...
		$days = $rowPrescr['days'];
		$total_dosage = $rowPrescr['total_dosage'];
		$notes = $rowPrescr['notes'];
		$prescriber = $rowPrescr['prescriber'];
		$nr = $rowPrescr['nr'];

		$prescr .= $article . '</td><td>' . $dosage . '</td><td>' . $times_per_day . '</td><td>' . $days . '</td><td>' . $total_dosage . '</td><td>' . $notes . '</
td><td>' . $prescriber . '';
		$prescr .= '</td></tr>';
	}
	if ($prescr == '') {
