...
while($row=$result->FetchRow()){
	if ($row['encounter_class_nr']==0) {
		$row['encounter_class_nr']=2;
	}
//echo 'what is here'.$row['history'].'<br>';	
...
?>
  ...
  <tr   class="<?php echo $bgc; ?>" >
	...
	<?php
		...
		if($row['death_date']&&$row['death_date']!=DBF_NODATE && $row['death_date']!='1980-01-01'){
