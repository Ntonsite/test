...
<table border=0 cellpadding=0 cellspacing=0 width="100%">
	...
	$i = 1;
        ...
        $img_gif = 'src="../../gui/img/common/default/fileman.gif" border=0 width="18" height="18"';
        ...
        for ($i = 0; $i < $z; $i++) {
            if ($pdata[$i]['pid'] != $pdata[($i - 1)]['pid']) {
                ...
                if (containFiles($sImagePath, '.dcm')) {
                    ...
                    $jpgFiles = &$img_obj->FilesListArray($sImagePath);
                    ...
                    foreach ($jpgFiles as $jpgFile) {
                        ...
                        <a href="#" onclick="openFile(\''.$sImagePath.$jpgFile. '\')"><img ' . $img_gif . '></a></td>';     
                    }
                }
                echo '
				<tr>
