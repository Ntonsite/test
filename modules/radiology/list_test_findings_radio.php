...
$main_fax_info = $GLOBAL_CONFIG['main_info_phone'] ?? "";
$main_email_info = $GLOBAL_CONFIG['main_info_email'] ?? "";
$main_address_info = $GLOBAL_CONFIG['main_info_address'] ?? "";
...
$main_address = $main_address_info;
...
//If findings are available add edit option/set edit to 1
				$edit = 1;
