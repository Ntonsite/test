...
<a href="javascript:gethelp('person_admit.php')"><img <?php echo createLDImgSrc($root_path, 'hilfe-r.gif', '0') ?>  <?php if ($cfg['dhtml']) {
...
<?php if ($_COOKIE['ck_login_logged' . $sid]) {
	echo $root_path . 'main/startframe.php' . URL_APPEND;
} else {
