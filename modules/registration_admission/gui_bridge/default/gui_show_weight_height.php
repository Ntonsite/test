...
<table border=0 cellpadding=4 cellspacing=1 width=100% class="frame">
    ...
    while (list($x, $row) = each($msr_comp)) {
        ...
        <tr bgcolor="<?php echo $bgc; ?>">
            <td width="17%" rowspan="11" align="left" valign="top" bgcolor="<?php echo $bgc; ?>"><?php echo @formatDate2Local($row['msr_date'], $date_format); ?></td>
            <td width="19%" align="left" valign="top"><b><?php echo $LDFileNr; ?><b></td>
                        ...
                        <tr bgcolor="<?php echo $bgc; ?>">
                            <td align="left" valign="top"><?php echo $LD['saturation']; ?></td>
                            <td align="left" valign="top" bgcolor="#FFFFFF"><?php print $row[14]['value'] . ' ' . $unit_ids[$row[14]['unit_nr']]; ?></td>
                            <td align="left" valign="top" bgcolor="#FFFFFF"><?php print $row[14]['notes']; ?></td>
                        </tr>
                        <tr bgcolor="<?php echo $bgc; ?>">
                            <td align="center" valign="top" colspan="4">
                                <?php
                                echo'<a href="show_weight_height.php' . URL_APPEND . '&pid=' . $_SESSION['sess_full_pid'] . '&target=' . $target .
                                '&encounter_nr=' . $row['encounter_nr'] . '&msr_date=' . $row['msr_date'] . '&msr_time=' . $row['msr_time'] . '&mode=update&update=1">' . $LDUpdate . '</a>';
                                ?>
                            </td>
                        </tr>
                        <?php
