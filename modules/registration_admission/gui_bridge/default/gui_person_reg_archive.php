...
$img_female=createComIcon($root_path,'spf.gif','0');
 ...
 while($result=$ergebnis->FetchRow()){
  ...
  echo '>
    ...
    <td>&nbsp; &nbsp;<a href="'.$buf.'" title="'.$LDClk2Show.'">'.ucwords($result['name_first']).'</a>';

	# If person is dead show a black cross

     // if ($dbf_nodate=='0000-00-00') {  	
...
$GLOBAL_CONFIG['person_name_2_hide']=$GLOBAL_CONFIG['person_name_2_hide'] ?? "";

$GLOBAL_CONFIG['person_name_3_hide']=$GLOBAL_CONFIG['person_name_3_hide'] ?? "";

$GLOBAL_CONFIG['person_name_middle_hide']= $GLOBAL_CONFIG['person_name_middle_hide'] ?? "";

$GLOBAL_CONFIG['person_name_maiden_hide']= $GLOBAL_CONFIG['person_name_maiden_hide'] ?? "";

$GLOBAL_CONFIG['person_name_others_hide']=$GLOBAL_CONFIG['person_name_others_hide'] ?? "";
$GLOBAL_CONFIG['person_phone_1_nr_hide']=$GLOBAL_CONFIG['person_phone_1_nr_hide'] ?? "";
$GLOBAL_CONFIG['person_phone_2_nr_hide']=$GLOBAL_CONFIG['person_phone_2_nr_hide'] ?? "";
$GLOBAL_CONFIG['person_cellphone_1_nr_hide']=$GLOBAL_CONFIG['person_cellphone_1_nr_hide'] ?? "";

$GLOBAL_CONFIG['person_cellphone_2_nr_hide']=$GLOBAL_CONFIG['person_cellphone_2_nr_hide'] ?? "";

$GLOBAL_CONFIG['person_fax_hide']=$GLOBAL_CONFIG['person_fax_hide'] ?? "";
...
$GLOBAL_CONFIG['person_email_hide']=$GLOBAL_CONFIG['person_email_hide'] ?? "";
...
$GLOBAL_CONFIG['person_citizenship_hide']=$GLOBAL_CONFIG['person_citizenship_hide'] ?? "";
...
$GLOBAL_CONFIG['person_sss_nr_hide']=$GLOBAL_CONFIG['person_sss_nr_hide'] ?? "";
...
$GLOBAL_CONFIG['person_nat_id_nr_hide']=$GLOBAL_CONFIG['person_nat_id_nr_hide'] ?? "";
...
$GLOBAL_CONFIG['person_religion_hide']=$GLOBAL_CONFIG['person_religion_hide'] ?? "";
...
$GLOBAL_CONFIG['person_ethnic_orig_hide']=$GLOBAL_CONFIG['person_ethnic_orig_hide'] ?? "";
