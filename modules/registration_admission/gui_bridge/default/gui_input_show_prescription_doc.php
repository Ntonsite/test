...
if (!empty($show)) {
	...
	if ($show == 'Drug-List-CTC') {
		$activated_tab = 'CTC-Drugs';
		$db_drug_filter = 'drug_list_ctc';
	}
	if ($show == 'Drug-List-NHIF') {
		$activated_tab = 'Drug-list-NHIF';
		$db_drug_filter = 'drug_list';
	}
	if ($show == 'Drug-List-All') {
		$activated_tab = 'Drug list for All';
		$db_drug_filter = 'drug_list_all';
	}
	...
	// echo $show.'<br>';
	// echo $activated_tab.'<br>';
	// echo $db_drug_filter.'<br>';
