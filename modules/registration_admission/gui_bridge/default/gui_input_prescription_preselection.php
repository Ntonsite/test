...
?>
            <td colspan="4">
                <table border="0" width="100%" cellpadding="0" cellspacing="0">
                    <tr>
                        <?php
                        $categories1 = array('service', 'eye-service', 'dental', 'dental', 'minor_proc_op', 'obgyne_op', 'ortho_op', 'surgical_op', 'druglist', 'CTC-Drugs', 'Supplies', 'supplies-lab', 'Drug list for All'); //activated tab

                        $categories2 = array('service', 'Eye-service', 'dental', 'dental', 'Minor_op', 'Obgyne_op', 'Ortho_op', 'Surgical_op', 'Drug List', 'Drug-List-CTC', 'Supplies', 'Supplies-Lab', 'Service-Meals'); //group
                        ...
                        $categories4 = array('Service/Registration', 'Eye Services', 'Dental Services', 'Dental Procedure', 'Minor Procedure', 'Obgyne', 'Orthopedic', 'Surgical OP', 'Drugs General', 'CTC Drugs', 'Supplies', 'OBGyne Procedures', 'Meals', 'Surgical Procedures'); //this is hint
                        ...
                        for ($i = $start; $i <= $end; ++$i) {
                            ...
                            if ($i == 12) {
                                echo '><div align="center"><a href="#" onClick="#"><img border="0" src="../../gui/img/common/default/' . $categories3[$i] . '" title ="' . $categories4[$i] . '"></a></div></td>';
                            }else{
        ...
        <tr>
            <td colspan="4" bgcolor="#red">
                <table width="100%" border="0" bgcolor="#CAD3EC" cellpadding="0" cellspacing="0">
                    <tr><td><input type="text" name="qsearch" id="qsearch" placeholder="Quick Search" style="width:100%; font-size:30px;" onkeyup="return search_drugs()" autofocus></td>
                    </tr>
                    <tr>
...
<?php $pres_obj->DisplaySelectedItems($item_no); ?>
                    ...
                    <tr>
                        <td height="20" align="center">
                            ...
                            if (isset($externalcall)) {
                                ?>
                                <input type="button" name="show" value="<?php echo $LDPrescribe; ?>" onClick="javascript:submit_form('<?php echo $thisfile . URL_APPEND; ?>&mode=new&prescrServ=<?php echo $_GET['prescrServ'] ?>&prescrSubCat=<?php echo $_GET['prescrSubCat'] ?>&show=insert&externalcall=<?php echo $externalcall; ?>&disablebuttons=<?php echo $disablebuttons; ?>&backpath=<?php echo urlencode($backpath); ?>')">
                                <?php
                            } else {
                                ?>
                                <input type="button" name="show" value="<?php echo $LDPrescribe; ?>" onClick="javascript:submit_form('<?php echo $thisfile . URL_APPEND; ?>&mode=new&prescrServ=<?php echo $_GET['prescrServ'] ?>&prescrSubCat=<?php echo $_GET['prescrSubCat'] ?>&show=insert&disablebuttons=<?php echo $disablebuttons; ?>&backpath=<?php echo urlencode($backpath); ?>')">
    <?php
}
?></td>
                    </tr>
