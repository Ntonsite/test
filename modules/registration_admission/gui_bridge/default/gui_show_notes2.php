...
while ($row = $result->FetchRow()) {
  ...
  <tr  bgcolor="<?php echo $bgc; ?>"  valign="top">
    <td><FONT SIZE=-1  FACE="Arial"><?php if (!empty($row['date'])) {
		echo @formatDate2Local($row['date'], $date_format);
	}
	?></td>
    ...
    <td><FONT SIZE=-1  FACE="Arial"><?php if ($row['personell_nr']) {
