...
if ($debug) {
	...
	echo "insurance name:" . $ins_obj->GetName_insurance_from_pid($pid) . "<br>";
}
...
//         return $this->getValue('insurance_ID', $pid);
//     }

// echo $ins_obj->GetName_insurance_from_id($id)
...
$ins_id = $person_obj->Insurance($_SESSION['sess_pid']);

$insname = $ins_obj->GetName_insurance_from_id($ins_id);
//echo $insname;
