...
if (empty($GLOBAL_CONFIG['notes_preview_maxlen'])) {
...
$person_foto_path = $GLOBAL_CONFIG['person_foto_path'] ?? "";

/* Check whether config foto path exists, else use default path */
$photo_path = (is_dir($root_path . $person_foto_path)) ? $person_foto_path : $default_photo_path;
