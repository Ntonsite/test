                    ...
                    <td  valign="top" align="middle" height="35">
                        <table cellspacing="0"  class="titlebar" border=0>
                            <tr valign=top  class="titlebar" >
                                <td bgcolor="#99ccff" >
                                    &nbsp;&nbsp;<font color="#330066">Enable Bank Reference number</font>
                                </td>
                        ...
                        <form  method="post" name="form">
                            <table border=0 cellspacing=1 cellpadding=5>
                                <tr>
                                    <td class="adm_item" align="right"><FONT  color="#0000cc"><b><?php echo 'Enable Bank Reference Number?'; ?></b></FONT></td>
                                    <td  align="left">

                                        <select name="bankref">
                                            <?php
$enable_bank_ref = $glob_obj->getConfigValue('enable_bank_ref');
if ($enable_bank_ref) {
