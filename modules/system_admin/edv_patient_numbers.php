...
if ($_POST['hospNo']) {
    ...
    $vc .= ($_POST['hno'] == 1) ? '1|' : '2|'; # HOSPITAL NUMBER
//    $vc .= ($_POST['ohno'] == 1) ? '1|' : '0|'; # OLD HOSPITAL NUMBER
    ...
    $vc .= ($_POST['prescribewithoutdiagnosis'] == 1) ? '1' : '0'; # User password Expiring Date
    ...
    $gen_hno = ($_POST['generate_hosp_fileno'] == 1) ? '1' : '0'; # Autogenerate Hospital File No Status

    $nb->_save_autogen_hospfn_status($gen_hno);
...
//echo $nhif_status . ' kkjkjkjk';
//Get autogenerate hospital file no status
$gen_hno_status = $nb->_autogen_hospfn_status();
?>
...
# ENCOUNTER NUMBER FOR KCMC
				...
				<td align="left" colspan="2"><FONT  color="#0000cc"><b>' . $LDHospitalFNr . '</b><br />' .
					  ...
					  ' . $LDOFNr . '</label>' .
						...
						<td><FONT  color="#0000cc"><b>Autogenerate ' . $LDHospitalFNr . '</b> </FONT></td>
						<td  style="width:10%; text-align:center;">' .
                            '<input type="checkbox" name="generate_hosp_fileno" ';
                            if ($gen_hno_status == 1)
                                print 'checked="true" ';
                            echo ' value="1">
			       </td>
...
# Password expiring features
                ...
                echo '<tr>
                        <td style="width:10%; text-align:center;"><img ' . createComIcon($root_path, 'post_discussion.gif', '0') . '></td>
                        <td><FONT  color="#0000cc"><b>Prescribe without Diagnosis</b> </FONT></td>
                        <td  style="width:10%; text-align:center;">' .
                            '<input type="checkbox" name="prescribewithoutdiagnosis" ';
                            if ($val[13] == 1)
                                print ' checked="true" ';
                            echo ' value="1" >
                   </td>
