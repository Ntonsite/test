...
<ul>
    <FONT  SIZE=+2>
        ...
        <?php
if (($mode == 'save') && $new_date_ok) {
	echo '<img ' . createMascot($root_path, 'mascot1_r.gif', '0', 'bottom') . '> ' . $LDNewDateFormatSaved . '<p>';
}
...
for ($i = 0; $i < sizeof($LDDateFormats); $i++) {
	...
	if ($date_format == $LDDateFormats[$i]) {
		echo " checked";
	}
