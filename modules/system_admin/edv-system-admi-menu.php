 ...
 * 
 * Modifications by Patrick Mark, 2014,2015
        ...
        <tr>
            <td bgcolor=<?php echo $cfg['body_bgcolor']; ?> colspan=2>
                ...
                <table border=0 cellspacing=1 cellpadding=2>
                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            &nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>><FONT  color="#0000cc" FACE="verdana,arial" size=2><a href="edv_user_roles_list.php?sid=<?php echo $sid . "&lang=" . $lang . "&src=sysadmin" ?>" target="SYSADMIN_WFRAME"> <?php echo $LDUserRoles; ?></a></FONT><br>
        ...
        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><a href="<?php echo $root_path; ?>modules/dept_admin/dept_manage.php<?php echo URL_APPEND; ?>" target="SYSADMIN_WFRAME"><?php echo $LDDeptAdmin ?></a></b> </FONT></td>
                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            ...
                            <FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_database_maintanance.php" target="SYSADMIN_WFRAME"><?php echo $LDDbMaint; ?>
                            </a></FONT>
                        </td>
                <!--  	<td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><a href="phpmyadmin-start.php?sid=<?php echo $sid . "&lang=" . $lang ?>"><?php echo $LDMySQLManage ?></a></b> </FONT></td>
                  ...
                  <tr>
                    ...
                    <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $LDRestrictNotbilled; ?></b> </FONT></td>
                    </tr>
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_restrict_unbilled.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $LDRestrictNotbilledCfg; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_bankref_enable.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $LDBankrefCfg; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                     <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $LDEnableDoctorToViewStockStatus; ?></b> </FONT></td>
                    </tr>
                    <tr>

                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_block_drugs.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $LDEnableDoctor; ?>
                            </a></FONT><br>
                        </td>
                    </tr>

                     <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $LDWeberpApiNurseChart; ?></b> </FONT></td>
                    </tr>
                    <tr>
                     ...
                     <tr>
                        <td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><?php echo $LDPriceReadOnly; ?></b> </FONT></td>
                    </tr>
                    <tr>

                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_price_readonly.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo $LDEnableReadonly; ?>
                            </a></FONT><br>
                        </td>
                    </tr>
                    <tr>
...
<!--                    <tr>
                        <td bgcolor="#ffffff"><FONT  color="#0000cc" FACE="verdana,arial" size=2>&nbsp;&nbsp;&nbsp;<img <?php echo createComIcon($root_path, 'redpfeil.gif', '0', 'absmiddle') ?>>
                            <a href="edv_allow_unbilled_ctc.php?sid=<?php echo $sid . "&lang=" . $lang ?>" target="SYSADMIN_WFRAME"><?php echo "Allow CTC Patients Consultation"; ?>
                            </a></FONT><br>
                        </td>
                    </tr>-->
           <!--  	<td bgcolor="#e9e9e9"><FONT  color="#0000cc" FACE="verdana,arial" size=2><b><a href="phpmyadmin-start.php?sid=<?php echo $sid . "&lang=" . $lang ?>"><?php echo $LDMySQLManage ?></a></b> </FONT></td>
