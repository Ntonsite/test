...
<form method="post">
    <table border=0 cellspacing=1 cellpadding=2>
        ...
        <?php
$themeControlBtn = $gc->getConfigValue('theme_control_buttons');
...
echo '<option ' . $gc->setSelectedConfig('blue_aqua', $themeControlBtn) . ' value="blue_aqua" >Blue Aqua</option>';
echo '</select>
       </td>
	</tr>';
?>
        ...
        <?php
$tlist = [];
while (list($x, $v) = $helper->CustomEach($tlist)) {
	?>
            <tr  bgcolor="#e9e9e9" >
                <td><FONT  color="#000099"><b></b></td>
