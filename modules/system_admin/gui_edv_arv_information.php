                            ...
                            <tr valign=top  class="titlebar" >
                                ...
                                <td bgcolor="#99ccff" align=right><a
                                        <a
                                            ...
                                            href="JavaScript:window.top.close()" ><img src="../../gui/img/control/blue_aqua/en/en_close2.gif" border=0 width="76" height="21" alt="" style="filter:alpha(opacity=70)" onMouseover="hilite(this,1)" onMouseOut="hilite(this,0)"></a>     </td>
                            </tr>
                    ...
                    <td bgcolor=#ffffff valign=top>
                        ...
                        <ul>
                            ...
                            <p>
                                ...
                                <?php
$main_info_facility_name = $glob_obj->getConfigValue('main_info_facility_name');
$main_info_facility_code = $glob_obj->getConfigValue('main_info_facility_code');
$main_info_facility_district = $glob_obj->getConfigValue('main_info_facility_district');
$main_info_facility_nhif_acreditation = $glob_obj->getConfigValue('main_info_facility_nhif_acreditation');
                            ...
                            <form  method="post" name="quickinfo">
                                <table border=0 cellspacing=1 cellpadding=5>
                                    <tr>
                                        ...
                                        <td class="adm_input"><input type="text" name="main_info_facility_name" size=40 maxlength=40 value="<?php echo $main_info_facility_name ?>">
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="adm_item" align="right"><FONT  color="#0000cc"><b>Code</b> </FONT></td>

                                        <td class="adm_input"><input type="text" name="main_info_facility_code" size=40 maxlength=40 value="<?php echo $main_info_facility_code ?>">
                                        </td>
                                    </tr>
                                     <tr>
                                        <td class="adm_item" align="right"><FONT  color="#0000cc"><b>NHIF Acreditation Account Number:</b> </FONT></td>

                                        <td class="adm_input"><input type="text" name="main_info_facility_nhif_acreditation" size=40 maxlength=40 value="<?php echo $main_info_facility_nhif_acreditation ?>">
                                        </td>
                                    </tr>

                                    <tr>
                                        <td class="adm_item" align="right"><FONT  color="#0000cc"><b>District</b> </FONT></td>
                                        <td class="adm_input"><input type="text" name="main_info_facility_district" size=40 maxlength=40 value="<?php echo $main_info_facility_district ?>">
                                        </td>
                                    </tr>
                                </table>
                                <p>
